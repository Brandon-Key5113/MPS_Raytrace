...
#srun -n 1 $COMMON_ARGS -c configs/twhitted.xml -p static_cycles_horizontal -cs 27
#srun -n 6 raytrace_mpi -h 1000 -w 1000 -c configs/twhitted.xml -p static_cycles_horizontal -cs 10
